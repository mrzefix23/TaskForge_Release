...
## Objectifs
- Finaliser la gestion visuelle des projets.
- Améliorer les messages d’erreurs côté front, en les récupérant correctement depuis le back.
...
- Suite de tests unitaires couvrant les nouvelles fonctionnalités.